...
## 4. Use dynamic timezone dates for durable memory
...
## 5. Validate against both Windows and Node/Electron
...
**Reference status:** dynamic local-time context, timezone-aware memory dates, deterministic timezone/daypart tests, TypeScript, production build, and runtime restart were verified in the September 5, 2026 reference build.